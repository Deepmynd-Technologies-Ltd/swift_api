...
from home.wallet_services import generate_secrete_phrases, get_transactions, get_wallet_balance, import_from_phrases, send_crypto_transaction
...
def get_transactions(request, symbol:Symbols, address:str):
  val = get_transactions(symbol, address)
